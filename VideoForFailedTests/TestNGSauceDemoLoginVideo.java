...
public class TestNGSauceDemoLoginVideo {
    ...
    public void setUp(){
        ...
        obj_context = obj_browser.newContext(new Browser.NewContextOptions()
    ...
    public void teardown(ITestResult iTestResult)
    {
        ...
        if(iTestResult.getStatus() == ITestResult.FAILURE)
            ...
            try{
                java.nio.file.Files.deleteIfExists(video.path());
            } catch (IOException e) {
