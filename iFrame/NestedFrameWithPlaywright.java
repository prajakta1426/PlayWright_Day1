...
public class NestedFrameWithPlaywright {
    public static void main(String[] args) {
        try(Playwright obj_playwright = Playwright.create())
        {
            ...
            //Nested Frame
            FrameLocator obj_nestedFrame = obj_Page.frameLocator("#outerFrame").frameLocator("#innerFrame");
            Locator innerFrameBtn = obj_nestedFrame.locator("#innerFrameBtn");
            innerFrameBtn.click();
            obj_Page.waitForTimeout(1000);
            Locator innerFrameResult = obj_nestedFrame.locator("#innerFrameResult");
            assertThat(innerFrameResult).containsText("Inner frame button clicked!");
            obj_Page.close();
